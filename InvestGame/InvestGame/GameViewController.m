...
-(void)SetarNoticias{
    ...
    noticias = [NSMutableArray arrayWithObjects:
                [[Noticia alloc]initNoticiacomTexto:@"Gasto energético para produzir moedas virtuais poderão afetar metas climáticas. Consumo atual já é equivalente a um país como Itália" comTitulo:@"Criptomoedas consomem 1% da energia elétrica do mundo" comOfertaMax:4 comOfertaMin:1 comDemandaMax:1 eComDemandaMin:0 tipo:@"Cripto" eFeedback:@"Noticia demonstra barreiras na utilização das criptomoedas, dificultando aceitação"] ,
                [[Noticia alloc]initNoticiacomTexto:@"Ex-craque do Real Madrid irá lançar a ARC (Arquimedes Real Coin), e já iniciou as pré-vendas" comTitulo: @"Arquimedinho Paulista vai lançar sua própria criptomoeda" comOfertaMax:5 comOfertaMin:1 comDemandaMax:10 eComDemandaMin:4 tipo:@"Cripto" eFeedback:@"Popularização das criptomoedas e com isso uma maior aceitação"],
                ...
                [[Noticia alloc]initNoticiacomTexto:@"Os cidadãos chineses ricos investiram seu dinheiro em cryptocoin para se preparar para uma desvalorização maciça na moeda" comTitulo:@"Cryptocoin sobe com a guerra cambial entre China e EUA" comOfertaMax:4 comOfertaMin:2 comDemandaMax:50 eComDemandaMin:20 tipo:@"Cripto"],
                [[Noticia alloc]initNoticiacomTexto:@"Ações da empresa fecharam a segunda-feira com alta de 14%, com isso, o valor dela saltou para CC 994,5 trilhão e a empresa segue a caminho de ser a primeira a valer CC 1 quatrilhão" comTitulo:@"Ações da Orange batem recorde e empresa passa a ser a 1º a valer CC 1 quadrilhão" comOfertaMax:20 comOfertaMin:2 comDemandaMax:100 eComDemandaMin:30 tipo:@"Cripto"],
        [[Noticia alloc]initNoticiacomTexto:@"Guerra comercial com a Ásia e críticas dos governos à Orange derrubam os mercados" comTitulo:@"Ações americanas estão perto de terem o pior início de trimestre da história" comOfertaMax:10 comOfertaMin:5 comDemandaMax:50 eComDemandaMin:20 tipo:@"Ação"],[[Noticia alloc]initNoticiacomTexto:@"A Orange se tornou nesta quinta-feira a primeira empresa com ações na Bolsa de Nova York a ultrapassar a marca de CC 1 quadrilhão em valor de mercado" comTitulo:@"1º a passar de CC 1 quadri nos EUA, Orange vale mais que a Bolsa americana" comOfertaMax:50 comOfertaMin:30 comDemandaMax:2 eComDemandaMin:0 tipo:@"Ação"],
        [[Noticia alloc]initNoticiacomTexto:@"Isenção foi usada por corretoras independentes para atrair clientes que mantinha investimento em bancos" comTitulo:@"Banco Parnamirim adota benefício de XP a clientes e zera taxa do Tesouro Direto" comOfertaMax:20 comOfertaMin:2 comDemandaMax:100 eComDemandaMin:30 tipo:@"Ação"],
        [[Noticia alloc]initNoticiacomTexto:@"Os ataques de hackers  triplicaram nos últimos meses. Esse aumento representou mais 25 milhões de novas tentativas em roubar criptomoedas" comTitulo:@"120,5 milhões de novos ataques tentaram roubar criptomoedas nos últimos 4 meses" comOfertaMax:90 comOfertaMin:10 comDemandaMax:10 eComDemandaMin:2 tipo:@"Ação"],
                [[Noticia alloc]initNoticiacomTexto:@"Taxas de crescimento da Orange (em milhões): Vendas em 2016 - 170,910.00; Vendas em 2017 - 233,715.00; Vendas em 2018 - 229,234.00. Crescimento anual: 7.62%" comTitulo:@"Report anual da Orange anima investidores" comOfertaMax:20 comOfertaMin:10 comDemandaMax:50 eComDemandaMin:30 tipo:@"Ação"],
                [[Noticia alloc]initNoticiacomTexto:@"O especialista investe na crypto a 2 anos e j;a tem mais de 2 mil moedas" comTitulo:@"Diretor da Ibovespa diz que cryptocoin sera a nova moeda mundial" comOfertaMax:1 comOfertaMin:0 comDemandaMax:2 eComDemandaMin:0 tipo:@"Ação"],
                [[Noticia alloc]initNoticiacomTexto:@"A novidade é que os valores da conta poderão ser aplicados no Tesouro Direto, com rendimentos diários" comTitulo:@"Yesbank cria conta para clientes aplicarem no Tesouro Direto" comOfertaMax:21 comOfertaMin:20 comDemandaMax:21 eComDemandaMin:20 tipo:@"Ação"],
                [[Noticia alloc]initNoticiacomTexto:@"Taxas de crescimento da Orange (em milhões): Vendas em 2016 - 170,910.00; Vendas em 2017 - 233,715.00; Vendas em 2018 - 229,234.00. Growth rates: 7.62." comTitulo:@"" comOfertaMax:40 comOfertaMin:30 comDemandaMax:43 eComDemandaMin:40 tipo:@"Ação"],
                ...
                [[Noticia alloc]initNoticiacomTexto:@"Isenção foi usada por corretoras independentes para atrair clientes que mantinha investimento em bancos." comTitulo:@"Banco Parnamirim adota benefício de XP a clientes e zera taxa do Tesouro Direto" comOfertaMax:0 comOfertaMin:0 comDemandaMax:0 eComDemandaMin:0 tipo:@"Fixo"],
