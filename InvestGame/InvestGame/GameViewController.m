...
-(void)SetarNoticias{
    ...
    noticias = [NSMutableArray arrayWithObjects:
                ...
                [[Noticia alloc]initNoticiacomTexto:@"Os ataques de hackers  triplicaram nos últimos meses. Esse aumento representou mais 5 milhões de novas tentativas em roubar criptomoedas." comTitulo:@"Diversos novos ataques a plataformas de criptomoedas nos últimos 4 meses" comOfertaMax:100 comOfertaMin:80 comDemandaMax:0 eComDemandaMin:0 tipo:@"Cripto" eFeedback:@"insegurança gera muito receio nas pessoas para investimentos digitais"],
                 [[Noticia alloc]initNoticiacomTexto:@"Empresa brasileira havia pedido registro do nome “Gay-me” no Instituto de Registros em 2017. Um ano antes o “Gay-me” havia sido lançado nos EUA pela Mazes." comTitulo:@"Ações da Orange caem após derrota para a Mazes" comOfertaMax:70 comOfertaMin:30 comDemandaMax:0 eComDemandaMin:0 tipo:@"Ação" eFeedback:@"repercussão negativa desanimando os investidores."],
                [[Noticia alloc]initNoticiacomTexto:@"Orange venceu Shone em leilão pela aquisição do grupo de televisão, Semview, com proposta de CC 39 bilhões." comTitulo:@"Grupo americano dispara na bolsa após oferta pela Semview" comOfertaMax:5 comOfertaMin:2 comDemandaMax:50 eComDemandaMin:20 tipo:@"Ação" eFeedback:@"crescimento da empresa aumenta força das ações"]
                ,nil];
